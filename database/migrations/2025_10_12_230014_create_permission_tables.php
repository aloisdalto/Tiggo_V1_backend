...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            $table->bigIncrements('id'); // PK Correcta
            $table->string('name');
        ...
        // TABLA PIVOTE 1: model_has_permissions
        Schema::create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $teams) {
            $table->id(); // <--- TU PK (Correcto)
            ...
            // --- CORRECCIÓN AQUÍ ---
            // Hemos cambiado primary() por unique() para evitar el error "Multiple primary key defined"
            if ($teams) {
                ...
                $table->unique([$columnNames['team_foreign_key'], PermissionRegistrar::$pivotPermission, $columnNames['model_morph_key'], 'model_type'],
                    'model_has_permissions_permission_model_type_unique'); // Cambiado nombre a _unique
            } else {
        ...
        // TABLA PIVOTE 2: model_has_roles
        ...
        // TABLA PIVOTE 3: role_has_permissions
